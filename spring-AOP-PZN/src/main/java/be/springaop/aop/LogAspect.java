...
public class LogAspect {
    ...
    @Pointcut("target(be.springaop.service.HelloService)")
    ...
    @Pointcut("execution(* be.springaop.service.HelloService.*(java.lang.String))")
    ...
    @Pointcut("execution(* be.springaop.service.*.*(..))")
